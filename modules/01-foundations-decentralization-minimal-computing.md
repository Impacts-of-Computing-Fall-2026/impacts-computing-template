...
3. **Deliverable:** Commit a forensic analysis (`LAB-SUBMISSION.md`, copied from [`LAB-SUBMISSION-TEMPLATE.md`](../LAB-SUBMISSION-TEMPLATE.md) — see the [Student Guide](../STUDENT-GUIDE.md)) to your repository. Compare the platform's data footprint against our course's markdown repository structure, defending whether bloated design represents an accidental software choice or an active, manipulative tool of data enclosure.
